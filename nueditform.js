    ...
    for(var R = 0 ; R < formRecords.length; R++){
        ...
        for(var i = 1 ; i < formObjects.length ; i++){
            ...
            if(formObjects[i].tab_title != nuTab && arguments.length == 2){                   //-- create a new TAB
                ...
                e.setAttribute('ondblclick',"if(!nuIsGA()){return;}window.nuControlKey = true;nuOpenForm('nuobject', '', 'nuobject', '', 'nuBuilder Objects', '" + nuFORM.form_id + "');window.nuControlKey = false;");
